...
- (void)updatePosition {
    ...
    CGFloat stringHeightBuffer = 10.0f;
    CGFloat stringAndContentHeightBuffer = 40.0f;
...
- (CAShapeLayer *)createRingLayerWithCenter:(CGPoint)center radius:(CGFloat)radius lineWidth:(CGFloat)lineWidth color:(UIColor *)color {
    ...
    slice.strokeColor = [UIColor whiteColor].CGColor;//color.CGColor;
...
- (UIView *)hudView {
    if(!_hudView) {
        ...
        _hudView.backgroundColor = [UIColor colorWithRed:34.0/255.0 green:34.0/255.0 blue:34.0/255.0 alpha:0.6];
